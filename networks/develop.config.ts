...
export const develop: NetworkUserConfig = {
  ...
  stacktical: {
    ...
    messengers: [
      ...
      {
        contract: CONTRACT_NAMES.ShipementOracle,
        useCaseName: USE_CASES.SHIPMENT,
        externalAdapterUrl: process.env.SHIPMENT_ADAPTER,
        dslaLpName: SERVICE_CREDITS.SHIPMENT.DSLA_LP.name,
        dslaLpSymbol: SERVICE_CREDITS.SHIPMENT.DSLA_LP.symbol,
        dslaSpName: SERVICE_CREDITS.SHIPMENT.DSLA_SP.name,
        dslaSpSymbol: SERVICE_CREDITS.SHIPMENT.DSLA_SP.symbol,
      },
    ],
    scripts: scripts,
  },
