  ...
  stacktical: {
    ...
    bootstrap: {
      allowance: [
        ...
        {
          contract: CONTRACT_NAMES.TravelOracle,
          token: CONTRACT_NAMES.LinkToken,
          allowance: '10',
        },
      ],
    ...
    messengers: [
      ...
      {
        contract: CONTRACT_NAMES.TravelOracle,
        useCaseName: USE_CASES.TRAVEL,
        externalAdapterUrl: process.env.TRAVEL_ADAPTER,
        dslaLpName: SERVICE_CREDITS.TRAVEL.DSLA_LP.name,
        dslaLpSymbol: SERVICE_CREDITS.TRAVEL.DSLA_LP.symbol,
        dslaSpName: SERVICE_CREDITS.TRAVEL.DSLA_SP.name,
        dslaSpSymbol: SERVICE_CREDITS.TRAVEL.DSLA_SP.symbol,
      },
    ],
    scripts: scripts,
  },
