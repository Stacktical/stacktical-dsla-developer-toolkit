...
import type {
  PolygonERC20,
  PolygonERC20Interface,
} from "../../../contracts/tokens/PolygonERC20";
...
type PolygonERC20ConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: PolygonERC20ConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class PolygonERC20__factory extends ContractFactory {
  constructor(...args: PolygonERC20ConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override attach(address: string): PolygonERC20 {
    return super.attach(address) as PolygonERC20;
  }
  override connect(signer: Signer): PolygonERC20__factory {
