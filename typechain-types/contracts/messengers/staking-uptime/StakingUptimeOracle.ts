...
export interface StakingUptimeOracleInterface extends utils.Interface {
  functions: {
...
export interface StakingUptimeOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingUptimeOracleInterface;
