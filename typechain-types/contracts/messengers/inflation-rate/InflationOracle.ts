...
export interface InflationOracleInterface extends utils.Interface {
  functions: {
...
export interface InflationOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InflationOracleInterface;
