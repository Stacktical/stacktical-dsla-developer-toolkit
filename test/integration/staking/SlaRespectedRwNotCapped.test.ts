...
describe('DSLA Protocol Staking Simulation - v1.5 - SLA Respected, Reward Not Capped', () => {
  ...
  // POOLS BALANCE
  let P1ProviderPool = "418224";
  let P1UserPool = "147276";
  ...
  // POOLS BALANCE
  let P2ProviderPool = "444998.7768";
  let P2UserPool = "120501.223200000";
  ...
  // POOLS BALANCE
  let P3ProviderPool = "466905.8991777600";
  let P3UserPool = "98594.100822240";
  ...
  // POOLS BALANCE
  let P4ProviderPool = "484830.3067072432320";
  let P4UserPool = "80669.6932927567680";
  ...
  before(async function () {
    ...
    sla = <SLA>(new ethers.Contract(allSLAs[19], slaDeployment.abi, ethers.provider));
