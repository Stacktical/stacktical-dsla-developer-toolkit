...
interface StakingAprMessengerInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingAprMessenger extends BaseContract {
  ...
  interface: StakingAprMessengerInterface;
