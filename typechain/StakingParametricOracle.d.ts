...
interface StakingParametricOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingParametricOracle extends BaseContract {
  ...
  interface: StakingParametricOracleInterface;
