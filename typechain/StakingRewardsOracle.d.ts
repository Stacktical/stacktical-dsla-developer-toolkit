...
interface StakingRewardsOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsOracle extends BaseContract {
  ...
  interface: StakingRewardsOracleInterface;
